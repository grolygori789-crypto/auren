export default {
  ...
  today: {
    ...
    checkin: 'Start daily check-in', savedTitle: 'Today is recorded.', savedCopy: 'These are your own observations for today. Auren will wait for continuity before inferring patterns.', editCheckin: 'Update today’s check-in', observed: 'Observed today',
  ...
  common: { build: 'Body Intelligence foundation', system: 'System' }
};
