export default {
  ...
  today: {
    ...
    checkin: 'Start daily check-in', savedTitle: 'Today, captured.', savedCopy: 'Your observations are saved. Auren will look for meaningful patterns as your personal baseline grows.', editCheckin: 'Update today’s check-in', observed: 'Observed today', observedLevels: { veryLow:'Very low', low:'Low', steady:'Steady', high:'High', excellent:'Excellent', calm:'Calm', light:'Light', moderate:'Moderate', highStress:'High', veryHighStress:'Very high' },
  ...
  you: {
    title: 'You', sub: 'Your body profile, settings, data and Auren preferences in one quiet place.', bodyProfile: 'Body profile', bodyProfileMissing: 'Age · height · weight · activity · goal', bodyProfileReady: 'Edit the context Auren uses about your body', identityEyebrow:'Personal identity', identityTitle:'Make Auren feel yours', identityCopy:'Add a profile photo stored privately on this device. Auren never uses it to judge or analyze your body.', identityUpload:'Add photo', identityChange:'Change photo', identityRemove:'Remove', identitySaved:'Profile photo updated.', identityRemoved:'Profile photo removed.', identityError:'Auren could not use that image.', language: 'Language', languageSub: 'Native English / ภาษาไทย', appearance: 'Auren Atmospheres', appearanceSub: 'Five curated tonal environments', privacy: 'Data & Privacy', privacySub: 'Export, delete and understand your data', motion: 'Motion', motionSub: 'Respect system Reduced Motion', noAccount: 'No account required', noAccountSub: 'Cloud backup can be added later without blocking V1', about: 'About Auren', aboutSub: 'Personal Health Intelligence',
  ...
  common: { build: 'Luxe Halo & profile identity', system: 'System' }
};
